...
The default workflow is offline and uses the supplied 60-case benchmark plus deterministic fake providers. Raw attempts are retained, candidate requests are structurally separated from protected evaluation data, and unknown latency/token/cost values remain unknown.
